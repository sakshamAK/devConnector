...
export const CreatePost = () => {
    const { chosenMedia, setMedia, src, setSrc, getEmoji, postText, setPostText, uploadPost } = usePost();
    ...
    const deleteImage = (idx) => setSrc(src.filter(item => item !== src[idx]))
    ...
    return (
        <div className={style["post-container"]}>
            <div style = {{display:"flex"}}>
                <img src={profileSrc} style = {{height:"3rem", width:"auto"}} alt="your image" />
            ...
            <div className={style["add-to-post"]}>
                <div className={style["upload-items"]}>
                    ...
                    <button className={style["post-btn"]} onClick={() => uploadPost(postData)} >Post</button>
                </div>
